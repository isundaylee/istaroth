...
def _process_single_item(
    ...
    try:
        ...
        with (
            data_repo.text_map_tracker() as text_map_tracker,
            data_repo.talk_tracker() as talk_tracker,
            data_repo.readables_tracker() as readables_tracker,
            issue_tracker.apply(),
        ):
...
def generate_all(
    ...
    text_map_tracker = data_repo.text_map_tracker()
