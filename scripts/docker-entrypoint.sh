...
ISTAROTH_CHECKPOINT_URL="${ISTAROTH_CHECKPOINT_URL:-https://github.com/isundaylee/istaroth/releases/download/checkpoint%2F20250820-32cd97b76a6cb51879a21ab77be6c92945475e43/chs.tar.gz}"
