...
ISTAROTH_CHECKPOINT_URL="${ISTAROTH_CHECKPOINT_URL:-https://github.com/isundaylee/istaroth/releases/download/checkpoint%2F20250808-2ee26458862e3f89fd86c9f7fac86b28d3b8701e/chs.tar.gz}"
