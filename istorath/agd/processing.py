...
def get_readable_metadata(readable_path: str, *, data_repo: repo.DataRepo) -> types.ReadableMetadata:
    ...
    for doc_item in document_data:
        ...
        raise ValueError(f"Document entry not found for localization ID: {localization_id}")
