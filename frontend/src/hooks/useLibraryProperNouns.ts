...
/**
 * Proper nouns to highlight in a library file: a static curated list (per
 * language, fast) and a per-file LLM extraction. Highlights nothing for the
 * first 2s, then falls back to the static list; the LLM result replaces it
 * whenever it arrives.
 */
