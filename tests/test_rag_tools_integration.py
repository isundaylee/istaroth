...
def test_text_dir(tmp_path: pathlib.Path) -> pathlib.Path:
    ...
    documents = {
        ...
        "venti_story.txt": (
            "温迪是蒙德的风神巴巴托斯，以吟游诗人的形象出现在人间。他热爱自由与诗歌，" "经常在天使的馈赠酒馆演奏。温迪曾经帮助蒙德人民推翻了旧贵族的统治。"
        ),
        "cooking_recipes.txt": (
            "提瓦特大陆的美食多种多样。蒙德烤蘑菇披萨需要蘑菇、面粉、卷心菜和奶酪。" "璃月的珍珠翡翠白玉汤使用豆腐、莲蓬和金鱼草制作，是一道清淡的素食料理。"
        ),
        ...
        "fishing_mechanics.txt": (
            "钓鱼需要鱼竿、鱼饵和耐心。不同的鱼类需要特定的鱼饵，例如果酿饵适合钓鳉鱼。" "黄金钓鱼协会提供各种钓鱼相关的奖励。雷鸣仙是稻妻特有的观赏鱼。"
        ),
        ...
        "mondstadt_culture.txt": (
            "蒙德崇尚自由，由西风骑士团守护。每年举办风花节庆祝春天的到来。" "蒙德的特产包括蒲公英酒、苹果酒和各种以风为主题的诗歌。巴巴托斯是他们信仰的风神。"
        ),
    }
