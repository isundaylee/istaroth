...
def test_nickname_replacement_english():
    ...
    result = text_cleanup.clean_text_markers(
        text, localization.Language.ENG, pronoun_map={}
    )
...
def test_nickname_replacement_chinese():
    ...
    result = text_cleanup.clean_text_markers(
        text, localization.Language.CHS, pronoun_map={}
    )
...
def test_empty_text():
    ...
    result = text_cleanup.clean_text_markers(
        "", localization.Language.ENG, pronoun_map={}
    )
    assert result == ""
