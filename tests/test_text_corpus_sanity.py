...
def test_chinese_corpus_sanity():
    ...
    test_cases = {
        ...
        "agd_character_story/10000089_芙宁娜.txt": "秘密藏心间，无人知我名。",
        ...
        "agd_book/1036_白夜国馆藏.txt": "我们称呼她「卡伊洛斯」，或者「不变世界的统领与执政」。真正秘密的名字，我们不敢直言，所以在这里倒写。「露塔斯伊」——我仅提一次。",
        "agd_book/200982_某人留下的铭记其一.txt": "…留给我们的唯有一条路，那就是希巴拉克的道路…",
        "agd_weapon/14414_白辰之环.txt": "抑或是用巧技让人造的流星在深空绽放的一族，",
        "agd_subtitle/117369531083246_Cs_Mengde_EQ401260901_AA_CHS.txt": "溪流与梦想汇入沧洋\n晶蝶点水的须臾\n星河下的少年白发成长",
        "agd_talk_group/143001_199002143_GadgetGroup.txt": "夜鸦乘务员: 客人，欢迎使用夜鸦航线，请问您想前往哪一个站点？",
        ...
        "agd_hangout/19017_云堇_-_郊野觅芳踪.txt": "韵宁: 能不能再派几位冒险家？这看着又要过去半天了…",
...
def test_english_corpus_sanity():
    ...
    test_cases = {
        ...
        "agd_character_story/10000089_Furina.txt": "My Secret Is Hidden Within Me, No One Will Know My Name",
        ...
        "agd_book/1036_The_Byakuyakoku_Collection.txt": 'We call her Kairos, or "the ruler of the unchanging world." We dare not speak her true, secret name, and so I pen it here, only once, and in reverse: "Htoratsi."',
        "agd_book/200982_Notes_Someone_Left_Behind_I.txt": "...The only road left to us is the path of Xbalanque...",
        "agd_weapon/14414_Hakushin_Ring.txt": "Or the clan who used ingenious techniques to make man-made meteors bloom in the skies...",
        "agd_subtitle/216139845462233_Cs_Mengde_EQ401260901_AA_EN.txt": "Far from my native land I roamed\nIn streams I slept\nMany seasons I met as the suns set and rose",
        "agd_talk_group/143001_199002143_GadgetGroup.txt": "Night Raven Flight Attendant: Welcome, dear guest, and thank you for choosing Nachtraben Airlines. Where do you wish to alight today?",
        ...
        "agd_hangout/19017_Yun_Jin_-_Countryside_Wandering.txt": "Yun Jin: I do apologize, I didn't see you there.",
