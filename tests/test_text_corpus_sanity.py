...
def test_chinese_corpus_sanity():
    ...
    test_cases = {
        ...
        "agd_book/200334_日月前事.txt": "我们称呼她「卡伊洛斯」，或者「不变世界的统领与执政」。真正秘密的名字，我们不敢直言，所以在这里倒写。「露塔斯伊」——我仅提一次。",
...
def test_english_corpus_sanity():
    ...
    test_cases = {
        ...
        "agd_book/200334_Before_Sun_and_Moon.txt": 'We call her Kairos, or "the ruler of the unchanging world." We dare not speak her true, secret name, and so I pen it here, only once, and in reverse: "Htoratsi."',
