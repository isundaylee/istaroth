...
def test_chinese_corpus_sanity():
    ...
    test_cases = {
        ...
        "agd_creature/97990234451511_CODEX_SUBTYPE_AUTOMATRON.txt": "与「侦察记录型」一样，是最早设计制造的新式发条机关机械之一（数百年后的如今已经无人将其称为「新式」。这在当时是用以区分传统发条势能动力的机械机关用的说法）。",
    }
...
def test_english_corpus_sanity():
    ...
    test_cases = {
        ...
        "agd_creature/97990234451511_CODEX_SUBTYPE_AUTOMATRON.txt": "Alongside the Recon Log Mek, this was one of the first new-type clockwork meka to be made",
    }
