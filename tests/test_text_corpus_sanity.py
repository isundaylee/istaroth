...
def test_chinese_corpus_sanity():
    ...
    test_cases = {
        ...
        "talks/talk_客人欢迎使用夜鸦航线请问您想前往哪一个站点_6800328.txt": "夜鸦乘务员: 客人，欢迎使用夜鸦航线，请问您想前往哪一个站点？",
        "talks/talk_风带来故事的种子时间使之发芽_34710.txt": "遗迹的铭文 (铭文): 「风带来故事的种子，时间使之发芽。」",
...
def test_english_corpus_sanity():
    ...
    test_cases = {
        ...
        "talks/talk_Seeds_of_stories_brought_by_the_wind_and_cultiva_34710.txt": 'Carving Marks (Inscription): "Seeds of stories, brought by the wind and cultivated by time."',
        "talks/talk_Welcome_dear_guest_and_thank_you_for_choosing_Na_6800328.txt": "Night Raven Flight Attendant: Welcome, dear guest, and thank you for choosing Nachtraben Airlines. Where do you wish to alight today?",
