...
def test_chinese_corpus_sanity():
    ...
    test_cases = {
        ...
        "agd_weapon/294414_白辰之环.txt": "抑或是用巧技让人造的流星在深空绽放的一族，",
...
def test_english_corpus_sanity():
    ...
    test_cases = {
        ...
        "agd_weapon/294414_Hakushin_Ring.txt": "Or the clan who used ingenious techniques to make man-made meteors bloom in the skies...",
